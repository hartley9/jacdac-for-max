var jacdac = (() => {
  ...
  // src/p5/p5.jacdac.ts
  var p5_jacdac_exports = {};
  __export(p5_jacdac_exports, {
    bus: () => bus,
    connect: () => connect,
    connectBtn: () => connectBtn,
    createConnectButton: () => createConnectButton,
    createDevToolsButton: () => createDevToolsButton,
    debug: () => debug2,
    devtoolsBtn: () => devtoolsBtn,
  ...
  var SRV_ACIDITY = 513243333;
  var SRV_AIR_PRESSURE = 504462570;
  ...
  var SRV_CLOUD_ADAPTER = 341864092;
  var SRV_CLOUD_CONFIGURATION = 342028028;
  var SRV_COLOR = 372299111;
  var SRV_COMPASS = 364362175;
  var SRV_CONTROL = 0;
  var SRV_DASHBOARD = 468029703;
  var SRV_DC_CURRENT_MEASUREMENT = 420661422;
  var SRV_DC_VOLTAGE_MEASUREMENT = 372485145;
  var SRV_DEVICE_SCRIPT_CONDITION = 295074157;
  var SRV_DEVICE_SCRIPT_MANAGER = 288680491;
  var SRV_DISTANCE = 337275786;
  var SRV_DMX = 298814469;
  var SRV_DOT_MATRIX = 286070091;
  var SRV_DUAL_MOTORS = 355063095;
  ...
  var SRV_HID_JOYSTICK = 437330261;
  ...
  var JD_SERVICE_INDEX_BROADCAST = 61;
  var JD_FRAME_FLAG_COMMAND = 1;
  var JD_FRAME_FLAG_ACK_REQUESTED = 2;
  var JD_FRAME_FLAG_IDENTIFIER_IS_SERVICE_CLASS = 4;
  var JD_FRAME_FLAG_LOOPBACK = 64;
  var JD_DEVICE_IDENTIFIER_BROADCAST_HIGH_MARK = 2863311530;
  ...
  var FRAME_SEND_DISCONNECT = "frameSendDisconnect";
  ...
  var FRAME_PROCESS = "frameProcess";
  var FRAME_SEND = "frameSend";
  ...
  var ERROR_NO_ACK = "no-ack";
  var ROLE_QUERY_SERVICE_OFFSET = "srvo";
  var ROLE_QUERY_SERVICE_INDEX = "srvi";
  var ROLE_QUERY_DEVICE = "dev";
  var ROLE_QUERY_SELF_DEVICE = "self";
  ...
  function pick(...values) {
    return values == null ? void 0 : values.find((x) => x !== void 0);
  }
  ...
  function setNumber(buf, fmt, offset, r) {
    ...
    if (fmt == 17 /* UInt64LE */ || fmt == 19 /* Int64LE */) {
      setNumber(buf, 11 /* UInt32LE */, offset, r >>> 0);
      setNumber(buf, 11 /* UInt32LE */, offset + 4, r / 4294967296);
      return;
    }
    for (let i = 0; i < inf.size; ++i) {
  ...
  function serviceSpecificationFromName(shortId) {
    if (!shortId)
      return void 0;
    return _serviceSpecifications.find((s) => s.shortId === shortId) || Object.values(_customServiceSpecifications).find(
    ...
    while (parser.parse()) {
      ...
      for (let v of arr) {
        if (parser.nfmt !== null) {
          ...
          if (trg) {
            v *= parser.div;
            const st = numberFormatToStorageType(
              parser.nfmt
            );
            if (parser.div == 1 && (st == 4 || st == -4))
              v = 0 | Math.round(v);
            else if (st != null)
              v = clampToStorage(Math.round(v), st);
  ...
  function jdpack(fmt, data) {
    ...
    if (nf !== null) {
      ...
      const st = numberFormatToStorageType(nf);
      let v = data[0];
      if (st != null) {
        if (st == 4 || st == -4)
          v = Math.round(v) | 0;
  ...
  function decodeRegister(service, pkt) {
    ...
    let regInfo = service == null ? void 0 : service.packets.find(
    ...
    if (regInfo.packFormat && pkt.data.length) {
      try {
        ...
        if (recoded !== void 0 && recoded !== toHex(pkt.data)) {
  ...
  function decodeEvent(service, pkt) {
    ...
    const evInfo = (service == null ? void 0 : service.packets.find(
  ...
  function decodeCommand(service, pkt) {
    ...
    const cmdInfo = (service == null ? void 0 : service.packets.find(
  ...
  function decodePipe(pkt) {
    ...
    const candidates = service.packets.filter(
      (p) => p.pipeType == pipeType && /pipe/.test(p.kind) && /meta/.test(p.kind) == meta && /command/.test(p.kind) == (dir == "command")
    ).filter(
      (p) => !meta || pkt.getNumber(4 /* UInt16LE */, 0) == p.identifier
    );
  ...
  function commandName(n, serviceClass2) {
    ...
    if (pref) {
      ...
      if (regName === void 0) {
        ...
        regName = (_b = serviceSpec == null ? void 0 : serviceSpec.packets.find(
    ...
    if (r === void 0) {
      const serviceSpec = serviceSpecificationFromClassIdentifier(serviceClass2);
      r = (_d = serviceSpec == null ? void 0 : serviceSpec.packets.find(
        (pkt) => (pkt.kind === "command" || pkt.kind === "report") && pkt.identifier === n
      )) == null ? void 0 : _d.name;
    }
    return r;
  }
  ...
  function hexDump(d) {
    const chunk = 32;
    if (d.length <= chunk)
      return toHex(d) + "\xA0|\xA0" + toAscii(d);
    const a = toArray(d);
    let r = "";
  ...
  var _Packet = class {
    ...
    static fromBinary(data, timestamp) {
      ...
      p.timestamp = timestamp != null ? timestamp : data._jacdac_timestamp;
      return p;
    }
    ...
    assignDevice(bus2) {
      if (!this.isMultiCommand && !this.device)
        this.device = bus2.device(this.deviceIdentifier, false, this);
    }
    toString() {
      let msg = `${shortDeviceId(this.deviceIdentifier)}/${this.serviceIndex}[${this.frameFlags}]: 0x${this.serviceCommand.toString(16)} sz=${this.size}`;
      if (this.size < 20)
        msg += ": " + toHex(this.data);
      else
    ...
    sendCoreAsync(bus2) {
      ...
      this.assignDevice(bus2);
      return bus2.sendPacketAsync(this);
    }
    sendReportAsync(dev) {
      if (!dev)
    ...
    sendAsMultiCommandAsync(bus2, service_class) {
      ...
      return this.sendCoreAsync(bus2);
    }
    static fromFrame(frame, timestamp, skipCrc = false) {
    ...
    get friendlyCommandName() {
      ...
      if (this.isCRCAck) {
        ...
        const pkt = spec == null ? void 0 : spec.packets.find(
          (pkt2) => pkt2.kind === "event" && pkt2.identifier === code
        );
  ...
  var Packet = _Packet;
  Packet._nextKey = 1;
  function frameToPackets(frame, timestamp, skipCrc = false) {
    if (timestamp === void 0)
      timestamp = frame._jacdac_timestamp;
    const size = frame.length < 12 ? 0 : frame[2];
    if (frame.length < size + 12) {
      warn(
        `${timestamp | 0}ms: got only ${frame.length} bytes; expecting ${size + 12}`
      );
      return [];
    } else if (size < 4) {
      ...
      if (!skipCrc) {
        ...
        if (actual != computed) {
          warn(
            `${timestamp | 0}ms: crc mismatch; sz=${size} got:${actual}, exp:${computed}, ${toHex(
              frame
            )}`
          );
          return [];
      ...
      for (let ptr = 12; ptr < 12 + size; ) {
        ...
        if (ptr + psz > 12 + size) {
          warn(
            `${timestamp | 0}ms: invalid frame compression, res len=${res.length}`
          );
          break;
        }
  ...
  var JDEventSource = class {
    ...
    on(eventName, handler) {
      if (!handler)
        return this;
      normalizeEventNames(eventName).forEach(
        (eventName2) => this.addListenerInternal(eventName2, handler, false)
      );
      return this;
    }
    off(eventName, handler) {
      normalizeEventNames(eventName).forEach(
        (eventName2) => this.removeListenerInternal(eventName2, handler)
      );
      return this;
    }
    once(eventName, handler) {
      normalizeEventNames(eventName).forEach(
        (eventName2) => this.addListenerInternal(eventName2, handler, true)
      );
      return this;
    }
    addListenerInternal(eventName, handler, once) {
      ...
      const listener = eventListeners.find(
        (listener2) => listener2.handler === handler
      );
      if (listener) {
        listener.once = !!once;
        return;
  ...
  var JDBridge = class extends JDClient {
    constructor(name, infrastructure = false) {
      super();
    ...
    receiveFrameOrPacket(data, sender) {
      const bus2 = this._bus;
      if (!bus2)
        return;
      this.packetProcessed++;
      if (sender)
        data._jacdac_sender = sender;
      if (!data._jacdac_sender)
        data._jacdac_sender = this.bridgeId;
      this.currFrame = data;
      bus2.sendFrameAsync(data);
      this.emit(FRAME_PROCESS, data);
      this.currFrame = null;
    }
    handleSendFrame(frame) {
      if (!this._bus || this.currFrame == frame || frame._jacdac_sender === this.bridgeId)
        return;
      this.packetSent++;
  ...
  // src/jdom/devtools.ts
  function startDevTools() {
    if (typeof window !== "undefined" && !/^https:\/\/microsoft.github.io\/jacdac-docs\//.test(
      window.location.href
    ))
      window.location.href = `https://microsoft.github.io/jacdac-docs/clients/javascript/devtools.html#${window.location.href}`;
  }
  function injectDevTools(bus2, options) {
    if (typeof window === "undefined" || document.getElementById("jacdac-dev-tools"))
      return void 0;
    ...
    iframe.allow = "gamepad; microphone; camera; accelerometer; gyroscope; ambient-light-sensor; magnetometer";
    iframe.sandbox.add(
      "allow-forms",
  ...
  function snapshotSensors(bus2, sparse) {
    const r = toMap(
      sensorSpecifications(),
      (srv) => srv.camelName,
      (srv) => {
        const r2 = bus2.services({
  ...
  var JDField = class extends JDNode {
    ...
    get id() {
      return `${this.nodeKind}:${this.member.service.device.deviceId}:${this.member.service.serviceIndex.toString(
        16
  ...
  var JDServiceMemberNode = class extends JDNode {
    ...
    get specification() {
      ...
      if (this._specification === null)
        this._specification = (_a = this.service.specification) == null ? void 0 : _a.packets.find(
          (packet) => this.isPacket(packet) && packet.identifier === this.code
        );
  ...
  var JDRegister = class extends JDServiceMemberNode {
    ...
    get fields() {
      var _a;
      if (!this._fields)
        this._fields = (_a = this.specification) == null ? void 0 : _a.fields.map(
    ...
    get objectValue() {
      ...
      return unpackedToObject(
        this.unpackedValue,
        specification == null ? void 0 : specification.fields,
        specification.name
      );
    }
    get intValue() {
    ...
    refresh(skipIfValue) {
      ...
      if (!!this.data && (skipIfValue || isConstRegister(this.specification)))
        return Promise.resolve();
      const bus2 = this.service.device.bus;
      return bus2.withTimeout(
        ...
        new Promise((resolve, reject) => {
          ...
          this.sendGetAsync().then(() => bus2.delay(REGISTER_REFRESH_RETRY_0)).then(() => {
            if (resolve)
              return this.sendGetAsync().then(
                () => bus2.delay(REGISTER_REFRESH_RETRY_1)
              );
          }).then(() => {
            if (resolve)
  ...
  var JDEvent = class extends JDServiceMemberNode {
    ...
    get unpackedValue() {
      ...
      return packFormat && ((_a = this._lastReportPkt) == null ? void 0 : _a.jdunpack(packFormat));
    }
    get count() {
      return this._count;
    }
  ...
  var OutPipe = class {
    ...
    static from(bus2, pkt, hosted) {
      const [idbuf, port] = pkt.jdunpack("b[8] u16");
      const id = toHex(idbuf);
      const dev = bus2.device(id, false, pkt);
    ...
    async sendData(buf, flags, closing) {
      if (!this.device) {
        if (closing)
          return;
        else
          throwError("sending data over closed pipe");
      }
  ...
  var JDService = class extends JDNode {
    ...
    get intensityRegister() {
      ...
      if (!this._intensityRegister) {
        const pkt = (_a = this.specification) == null ? void 0 : _a.packets.find(
          (pkt2) => isIntensity(pkt2)
        );
    ...
    registers(options) {
      if (!this._registers) {
        ...
        this._registers = ((spec == null ? void 0 : spec.packets) || []).filter(isRegister).map((pkt) => new JDRegister(this, pkt.identifier));
      }
    ...
    event(eventCode) {
      ...
      if (!event) {
        ...
        if (spec && !spec.packets.some(
          ...
          if (Flags.diagnostics)
            console.debug(
              `attempting to access event ${SystemEvent[eventCode] || `0x${eventCode.toString(16)}`}`
            );
          return void 0;
        }
    ...
    sendCmdPackedAsync(cmd, values, ack) {
      ...
      const packFormat = spec == null ? void 0 : spec.packFormat;
      if (!packFormat)
        throw new Error("Unknown packing format");
      const data = values ? jdpack(packFormat, values) : void 0;
      return this.sendCmdAsync(cmd, data, ack);
    }
    sendCmdAwaitResponseAsync(pkt, timeout = 500) {
      const { bus: bus2 } = this.device;
      return new Promise((resolve, reject) => {
  ...
  var LEDController = class extends JDEventSource {
    ...
    async blink(from, to, interval, repeat) {
      ...
      const { bus: bus2 } = this.service.device;
      for (let i = 0; i < repeat; ++i) {
        await this.service.sendCmdAsync(this.command, on);
        await bus2.delay(interval - 1);
  ...
  var DeviceStatsMonitor = class extends JDEventSource {
    constructor() {
      ...
      this._restarts = 0;
      this._announce = 0;
      this._data = Array(15 << 2).fill(0).map(() => ({ received: 0, restartCounter: 0, restarts: 0 }));
      this._dataIndex = 0;
    }
    get announce() {
    ...
    get dropped() {
      const r = this._data.filter((e) => !!e.restartCounter).reduce(
  ...
  var JDDevice = class extends JDNode {
    constructor(bus2, deviceId, pkt) {
      ...
      this.created = this.lastSeen = bus2.timestamp;
    ...
    describe() {
      ...
      return this.toString() + (this.isPhysical ? "" : " (sim)") + ": " + this.services().filter((srv) => ignoredServices.indexOf(srv.serviceClass) < 0).map(
        (s) => {
          var _a;
    ...
    get firmwareInfo() {
      ...
      const productIdentifier = (_a = ctrl == null ? void 0 : ctrl.register(
        385 /* ProductIdentifier */
      )) == null ? void 0 : _a.uintValue;
      const bootloaderProductIdentifier = (_b = ctrl == null ? void 0 : ctrl.register(
        388 /* BootloaderProductIdentifier */
      )) == null ? void 0 : _b.uintValue;
      const ready = productIdentifier !== void 0 || bootloaderProductIdentifier !== void 0;
      if (!ready)
        return void 0;
      const deviceId = this.deviceId;
      const name = (_c = ctrl == null ? void 0 : ctrl.register(384 /* DeviceDescription */)) == null ? void 0 : _c.stringValue;
    ...
    refreshFirmwareInfo() {
      ...
      firmwareRegs.map((code) => ctrl.register(code)).filter((reg) => !!reg).forEach(
        (reg) => reg.once(REPORT_UPDATE, () => {
          this.emitPropagated(DEVICE_FIRMWARE_INFO);
    ...
    set firmwareUpdater(value) {
      ...
      if (value !== this._firmwareUpdater) {
        ...
        if (!this._firmwareUpdater) {
          const reg = (_a = this.service(0)) == null ? void 0 : _a.register(
            389 /* FirmwareVersion */
          );
    ...
    async resolveFirmwareVersion(retry = 0) {
      var _a;
      const register = (_a = this.service(0)) == null ? void 0 : _a.register(389 /* FirmwareVersion */);
      if (!register)
        return void 0;
      while (retry-- >= 0 && register.data === void 0)
        await register.refresh(true);
  ...
  async function sendStayInBootloaderCommand(bus2) {
    const bl_announce = Packet.onlyHeader(0 /* Info */);
    await bl_announce.sendAsMultiCommandAsync(bus2, SRV_BOOTLOADER);
  }
  ...
  var JDRegisterServer = class extends JDEventSource {
    constructor(service, identifier, defaultValue) {
      ...
      this.skipBoundaryCheck = !((_b = this.specification) == null ? void 0 : _b.fields.some(
    ...
    handlePacket(pkt) {
      ...
      if (pkt.isRegisterGet) {
        ...
        if (this.shouldNormalize() || this.valueProcessor) {
          try {
            let values = jdunpack(d, this.packFormat);
            if (this.shouldNormalize())
              this.normalize(values);
            if (this.valueProcessor)
              values = this.valueProcessor(values);
  ...
  var JDServiceServer = class extends JDEventSource {
    constructor(serviceClass2, options) {
      ...
      this.statusCode = this.addRegister(
        259 /* StatusCode */,
        [0 /* Ready */, 0]
      );
      if (valueValues)
      ...
      if (intensityValues) {
        ...
        if (isActive)
          intensity.on(CHANGE, () => {
            ...
            if (ev !== void 0)
              this.sendEvent(
                isActive(intensity.values()) ? 1 /* Active */ : 2 /* Inactive */
              );
          });
      }
      if (variant)
      ...
      registerValues == null ? void 0 : registerValues.forEach(
        ({ code, values }) => this.addRegister(code, values)
      );
      this.statusCode.on(
        CHANGE,
        () => this.sendEvent(4 /* StatusCodeChanged */, this.statusCode.data)
      );
      if (this.specification.packets.find(
        (pkt) => pkt.kind === "command" && pkt.identifier === 2 /* Calibrate */
      )) {
        this.addCommand(
          2 /* Calibrate */,
    ...
    get timestamp() {
      var _a, _b, _c;
      const bus2 = ((_a = this.device) == null ? void 0 : _a.bus) || ((_c = (_b = this._twin) == null ? void 0 : _b.device) == null ? void 0 : _c.bus);
      return bus2 == null ? void 0 : bus2.timestamp;
    }
    register(code) {
    ...
    async sendEvent(eventCode, data) {
      ...
      if (!device)
        return;
      const { bus: bus2 } = device;
      if (!bus2)
        return;
      const now = bus2.timestamp;
  ...
  var SensorServer = class extends JDServiceServer {
    constructor(serviceClass2, options) {
      ...
      this.streamingInterval = this.addRegister(
        4 /* StreamingInterval */,
        [
      ...
      if (preferredStreamingInterval !== void 0)
        this.preferredStreamingInterval = this.addRegister(
          258 /* StreamingPreferredInterval */,
          [preferredStreamingInterval]
        );
      if (readingError !== void 0) {
        this.readingError = this.addRegister(
          262 /* ReadingError */,
          readingError
        );
  ...
  var RealTimeClockServer = class extends SensorServer {
    constructor() {
      ...
      this.precision = this.addRegister(
        385 /* Precision */,
        [0]
      );
    ...
    static async syncTime(bus2) {
      ...
      await pkt.sendAsMultiCommandAsync(bus2, SRV_REAL_TIME_CLOCK);
    }
    handleSetTime(pkt) {
    }
    refreshTime() {
  ...
  var Transport = class extends JDEventSource {
      ...
      this._cleanups = [
        (_b = (_a = options == null ? void 0 : options.connectObservable) == null ? void 0 : _a.subscribe({
          next: async () => {
            ...
            if (Flags.diagnostics)
              console.debug(
                `${this.type}: device detected, connect ${((_a2 = this.bus) == null ? void 0 : _a2.autoConnect) ? "auto" : "manual"}`
              );
            if (((_b2 = this.bus) == null ? void 0 : _b2.disconnected) && ((_c2 = this.bus) == null ? void 0 : _c2.autoConnect)) {
              await delay(TRANSPORT_CONNECT_RETRY_DELAY);
              if (((_d2 = this.bus) == null ? void 0 : _d2.disconnected) && ((_e = this.bus) == null ? void 0 : _e.autoConnect)) {
    ...
    async sendPacketWhenConnectedAsync(frame) {
      if (this.connected)
        await this.transportSendPacketAsync(frame);
      else
        this.emit(FRAME_SEND_DISCONNECT, frame);
    }
    connect(background) {
      if (Flags.diagnostics)
        console.debug(
  ...
  var BusStatsMonitor = class extends JDEventSource {
    constructor(bus2) {
      ...
      bus2.on(PACKET_SEND, this.handlePacketSend.bind(this));
      bus2.on(PACKET_PROCESS, this.handlePacketProcess.bind(this));
      bus2.on(SELF_ANNOUNCE, this.handleSelfAnnounce.bind(this));
    }
    get current() {
      var _a;
      const r = {
      ...
      return {
        ...
        transport: (_a = this.bus.transports.find(
  ...
  var ControlServer = class extends JDServiceServer {
    constructor(options) {
      ...
      this.deviceDescription = this.addRegister(
        384 /* DeviceDescription */
      );
      this.mcuTemperature = this.addRegister(
        386 /* McuTemperature */,
        [25]
      );
  ...
  var ProtocolTestServer = class extends JDServiceServer {
    ...
    init(rwi, roi, ci, ei, ...values) {
      ...
      this.addCommand(
        ci,
        (pkt) => rw.setValues(jdunpack(pkt.data, rw.specification.packFormat))
      );
      return rw;
    }
  ...
  var _BuzzerServer = class extends JDServiceServer {
    ...
    handlePlayTone(pkt) {
      const [period, , duration] = jdunpack(
        pkt.data,
        "u16 u16 u16"
      );
  ...
  var CharacterScreenServer = class extends JDServiceServer {
    constructor(options) {
      ...
      this.brightness = this.addRegister(
        1 /* Brightness */,
        [brightness]
      );
      ...
      this.textDirection = this.addRegister(
        130 /* TextDirection */,
  ...
  var GAMEPAD_DPAD_XY_BUTTONS = GAMEPAD_DPAD_BUTTONS | 1024 /* X */ | 2048 /* Y */;
  ...
  var GamepadServer = class extends SensorServer {
    constructor(options) {
      ...
      this.buttonsAvailable = this.addRegister(
        384 /* ButtonsAvailable */,
        [buttonsAvailable]
      );
    }
    get isAnalog() {
  ...
  var LedStripServer = class extends JDServiceServer {
    constructor(options) {
      ...
      this.actualBrightness = this.addRegister(
        384 /* ActualBrightness */,
        [15]
      );
      this.lightType = this.addRegister(
        128 /* LightType */,
        [0 /* WS2812B_GRB */]
      );
      ...
      if (numColumns !== void 0)
        this.numColumns = this.addRegister(
          131 /* NumColumns */,
          [numColumns]
        );
      this.brightness.on(
    ...
    prog_fade(len, usehsv) {
      ...
      for (; ; ) {
        ...
        const col = rgb(
          col0.r * fade0 + col1.r * fade1 + 32768 >> 16,
          col0.g * fade0 + col1.g * fade1 + 32768 >> 16,
          col0.b * fade0 + col1.b * fade1 + 32768 >> 16
        );
  ...
  var MotorServer = class extends JDServiceServer {
    constructor(instanceName, options) {
      ...
      this.speed = this.addRegister(2 /* Speed */, [0]);
      ...
      if (loadRotationSpeed)
        this.loadRotationSpeed = this.addRegister(
          385 /* LoadRotationSpeed */,
          [loadRotationSpeed]
        );
    }
  };
    ...
    constructor(serviceClass2, options) {
      ...
      if (inactiveThreshold !== void 0 || this.activeThreshold !== void 0) {
        if (inactiveThreshold !== void 0)
          this.inactiveThreshold = this.addRegister(
            5 /* InactiveThreshold */,
            [inactiveThreshold]
          );
        if (activeThreshold !== void 0)
          this.activeThreshold = this.addRegister(
            6 /* ActiveThreshold */,
            [activeThreshold]
          );
  ...
  var RainGaugeServer = class extends AnalogSensorServer {
    constructor(options) {
      ...
      this.precipitationPrecision = this.addRegister(
        264 /* PrecipitationPrecision */,
        [bucketSize || 0.2794]
      );
      this._level = 0;
    }
  ...
  var RotaryEncoderServer = class extends SensorServer {
    constructor() {
      ...
      this.clicksPerTurn = this.addRegister(
        384 /* ClicksPerTurn */,
        [12]
      );
    }
  ...
  var ServoServer = class extends JDServiceServer {
    constructor(options) {
      ...
      this.actualAngle = this.addRegister(257 /* ActualAngle */, [0]);
      this.enabled = this.addRegister(1 /* Enabled */, [false]);
      this.minAngle = this.addRegister(272 /* MinAngle */, [
        minAngle
      ]);
      this.maxAngle = this.addRegister(273 /* MaxAngle */, [
        maxAngle
      ]);
      this.offset = this.addRegister(129 /* Offset */, [0]);
      this.responseSpeed = this.addRegister(
        385 /* ResponseSpeed */,
        responseSpeed !== void 0 ? [responseSpeed] : void 0
      );
      this.stallTorque = this.addRegister(
        384 /* StallTorque */,
        stallTorque !== void 0 ? [stallTorque] : void 0
      );
  ...
  var TrafficLightServer = class extends JDServiceServer {
    constructor(options) {
      ...
      this.red = this.addRegister(128 /* Red */, [false]);
      this.yellow = this.addRegister(129 /* Yellow */, [false]);
  ...
  var BitRadioServer = class extends JDServiceServer {
    constructor() {
      ...
      this.transmissionPower = this.addRegister(
        129 /* TransmissionPower */,
        [6]
      );
      this.frequencyBand = this.addRegister(
        130 /* FrequencyBand */,
        [7]
      );
      this.addCommand(
  ...
  var PowerServer = class extends JDServiceServer {
    constructor(options) {
      ...
      this.allowed = this.addRegister(1 /* Allowed */, [false]);
      this.maxPower = this.addRegister(7 /* MaxPower */, [500]);
      this.powerStatus = this.addRegister(
        385 /* PowerStatus */,
        [0 /* Disallowed */]
      );
      this.currentDraw = this.addRegister(257 /* CurrentDraw */, [0]);
      this.allowed.on(CHANGE, this.handleAllowedChange.bind(this));
    }
    handleAllowedChange() {
      const allowed = !!this.allowed.values()[0];
      if (allowed) {
        this.powerStatus.setValues([1 /* Powering */]);
        this.currentDraw.setValues([250]);
      } else {
        this.powerStatus.setValues([0 /* Disallowed */]);
  ...
  var reverseSelectors = Object.keys(
    selectors
  ).reduce((r, key) => {
    if (!r[selectors[key]])
      r[selectors[key]] = key;
  ...
  var HIDMouseServer = class extends JDServiceServer {
    ...
    handleSetButton(pkt) {
      ...
      this.setLastCommand(
        `set buttons ${btns || "?"} ${(HidMouseButtonEvent[event] || "?").toLocaleLowerCase()}`
      );
    }
    handleWheel(pkt) {
  ...
  // src/servers/azureiothubconfigurationserver.ts
  ...
  function parsePropertyBag(msg, separator) {
    const r = {};
    msg.split(separator || "&").map((kv) => splitPair(kv)).forEach(
      (parts) => r[decodeURIComponent(parts[0])] = decodeURIComponent(parts[1])
    );
    return r;
  }
  var AzureIoTHubConfigurationServer = class extends JDServiceServer {
    constructor(options, connStringSetting) {
      var _a;
      super(SRV_CLOUD_CONFIGURATION, options);
      this.connStringSetting = connStringSetting;
      this.isReal = false;
      this.serverName = this.addRegister(384 /* ServerName */, [
        ""
      ]);
      ...
      this.cloudType = this.addRegister(387 /* CloudType */, [
        "Azure IoT Hub"
      ]);
      this.connectionStatus = this.addRegister(
        386 /* ConnectionStatus */,
        [2 /* Disconnected */]
      );
  ...
  var _VibrationMotorServer = class extends JDServiceServer {
    constructor(options) {
      ...
      this.maxVibrations = this.addRegister(
        384 /* MaxVibrations */,
        [maxVibrations]
      );
      this.addCommand(
  ...
  var WifiServer = class extends JDServiceServer {
    ...
    get scannedKnownNetworks() {
      return this._lastScanResults.filter(
        (n) => this._knownNetworks.some((kn) => kn.ssid === n.ssid)
      );
    }
    handleReconnect() {
      this.disconnect();
    ...
    async handleLastScanResults(pkt) {
      ...
      await pipe.respondForEach(
        ...
        ({ flags, rssi, channel, bssid, ssid }) => jdpack(
    ...
    async handleListKnownNetworks(pkt) {
      ...
      await pipe.respondForEach(
        this._knownNetworks,
        ({ priority, flags, ssid }) => jdpack("i16 i16 s", [
          priority,
          flags,
          ssid
        ])
  ...
  var LedServer = class extends JDServiceServer {
    constructor(options) {
      ...
      this.brightness = this.addRegister(1 /* Brightness */, [15]);
      this.actualBrightness = this.addRegister(
        384 /* ActualBrightness */,
        [15]
      );
      this.numPixels = this.addRegister(386 /* NumPixels */, [n]);
      this.maxPower = this.addRegister(7 /* MaxPower */, [maxPower]);
      if (numColumns !== void 0)
        this.numColumns = this.addRegister(387 /* NumColumns */, [
          numColumns
        ]);
      if (ledsPerPixel !== void 0)
        this.ledsPerPixel = this.addRegister(388 /* LedsPerPixel */, [
          ledsPerPixel
        ]);
      if (luminousIntensity !== void 0)
        this.luminousIntensity = this.addRegister(
          390 /* LuminousIntensity */,
          [luminousIntensity]
        );
      if (waveLength !== void 0)
        this.waveLength = this.addRegister(389 /* WaveLength */, [waveLength]);
  ...
  // src/servers/hidjoystickserver.ts
  var HIDJoystickServer = class extends JDServiceServer {
    constructor(options) {
      super(SRV_HID_JOYSTICK, options);
      this.buttons = new Uint8Array();
      this.axis = new Uint8Array();
      const {
        buttonCount = 16,
        axisCount = 6,
        buttonsAnalog = false
      } = options || {};
      this.addRegister(384 /* ButtonCount */, [buttonCount]);
      this.addRegister(386 /* AxisCount */, [axisCount]);
      this.addRegister(385 /* ButtonsAnalog */, [buttonsAnalog]);
      this.addCommand(
        128 /* SetButtons */,
        this.handleSetButtons.bind(this)
      );
      this.addCommand(129 /* SetAxis */, this.handleSetAxis.bind(this));
    }
    handleSetButtons(pkt) {
  ...
  // src/servers/magneticfieldlevelserver.ts
  var _MagneticFieldLevelServer = class extends SensorServer {
    constructor(options) {
    ...
    get variant() {
      const reg = this.register(263 /* Variant */);
      const [v] = reg.values();
      return v;
    }
    update() {
      const [strength] = this.reading.values();
      if (Math.abs(strength) >= _MagneticFieldLevelServer.ACTIVE_THRESHOLD) {
        this.setState(3 /* Active */);
      } else if (Math.abs(strength) <= _MagneticFieldLevelServer.INACTIVE_THRESHOLD) {
        this.setState(2 /* Inactive */);
      } else
        this.setState(1 /* Neutral */);
    }
    setState(state) {
      ...
      switch (state) {
        case 3 /* Active */:
          this.sendEvent(1 /* Active */);
          break;
        case 2 /* Inactive */:
          this.sendEvent(2 /* Inactive */);
          break;
      }
    }
  };
  var MagneticFieldLevelServer = _MagneticFieldLevelServer;
  MagneticFieldLevelServer.ACTIVE_THRESHOLD = 0.3;
  MagneticFieldLevelServer.INACTIVE_THRESHOLD = 0.1;

  // src/servers/dualmotorsserver.ts
  var DualMotorsServer = class extends JDServiceServer {
    constructor(instanceName, options) {
      super(SRV_DUAL_MOTORS, { instanceName });
      const { loadTorque, loadRotationSpeed } = options || {};
      this.speed = this.addRegister(
        2 /* Speed */,
        [0, 0]
      );
      this.enabled = this.addRegister(1 /* Enabled */, [
      ...
      if (loadTorque)
        this.loadTorque = this.addRegister(
          384 /* LoadTorque */,
          [loadTorque]
        );
      if (loadRotationSpeed)
  ...
  // src/servers/cloudadapterserver.ts
  var UPLOAD = "upload";
  var UPLOAD_BIN = "uploadBin";
  var CloudAdapterServer = class extends JDServiceServer {
    constructor(options) {
      super(SRV_CLOUD_ADAPTER, options);
      this.seqNo = 0;
      this.pending = {};
      this.controlled = !!(options == null ? void 0 : options.controlled);
      this.connectedRegister = this.addRegister(384 /* Connected */, [
        false
      ]);
      this.connectionNameRegister = this.addRegister(
        385 /* ConnectionName */,
        [(options == null ? void 0 : options.connectionName) || ""]
      );
      this.addCommand(128 /* Upload */, this.handleUpload.bind(this));
      this.addCommand(
        129 /* UploadBin */,
      ...
      this.connectedRegister.on(
        CHANGE,
        () => this.sendEvent(3 /* Change */)
      );
      this.connectionNameRegister.on(
        CHANGE,
        () => this.sendEvent(3 /* Change */)
      );
    }
    ...
    async handleUpload(pkt) {
      if (!this.connected) {
        console.debug(`cloud: cancel upload, not connected`);
        return;
      }
      const [label, args] = pkt.jdunpack("z f64[]");
      this.upload(label, args);
    }
    async handleUploadBin(pkt) {
      if (!this.connected) {
        console.debug(`cloud: cancel upload, not connected`);
        return;
      }
    ...
    upload(label, args) {
      this.emit(UPLOAD, { label, args });
    }
    uploadBin(data) {
      this.emit(UPLOAD_BIN, { data });
    }
    sendCloudCommand(method, args, timeout = 1e3) {
      if (!this.connected) {
        console.debug(`cloud: cancel send, not connected`);
        return;
      }
      const seqNo = this.seqNo++;
      const payload = jdpack("u32 z r: f64", [
        seqNo,
        method,
        args.map((v) => [v])
      ]);
      return new Promise((resolve, reject) => {
        ...
        this.sendEvent(129 /* CloudCommand */, payload);
      });
    }
    async handleAckCloudCommand(pkt) {
      const [seqNo, status, args] = pkt.jdunpack(
        "u32 u32 f64[]"
      );
    ...
    gcPending() {
      const now = this.device.bus.timestamp;
      Object.entries(this.pending).filter(([, req]) => req.timeout > now).map(([key]) => {
        var _a;
        const reject = (_a = this.pending[key]) == null ? void 0 : _a.reject;
        delete this.pending[key];
        return reject;
      }).filter((r) => !!r).forEach((r) => r(TIMEOUT));
    }
    clearPending() {
  ...
  // src/servers/satnavserver.ts
  var SatNavServer = class extends SensorServer {
    constructor(options) {
      super(
        SRV_SAT_NAV,
        options || {
    ...
    setGeolocationPosition(loc, skipChangeEvent) {
  ...
  // src/jdom/clients/devicescriptmanagerclient.ts
  var _DeviceScriptManagerClient = class extends JDServiceClient {
    constructor(service) {
      super(service);
      ...
      this.mount(
        changeEvent.subscribe(
          EVENT,
          () => this.emit(_DeviceScriptManagerClient.PROGRAM_CHANGE)
        )
      );
      const panicEvent = service.event(128 /* ProgramPanic */);
      this.mount(
        panicEvent.subscribe(
          EVENT,
          (args) => this.emit(
            _DeviceScriptManagerClient.PROGRAM_PANIC,
            ...args || []
          )
        )
      );
    }
    deployBytecode(bytecode, onProgress) {
  ...
  var DeviceScriptManagerClient = _DeviceScriptManagerClient;
  DeviceScriptManagerClient.PROGRAM_CHANGE = "programChange";
  DeviceScriptManagerClient.PROGRAM_PANIC = "programPanic";
  ...
  var BluetoothTransport = class extends Transport {
    ...
    async transportSendPacketAsync(data) {
    ...
    async transportDisconnectAsync() {
      ...
      try {
        (_a = this._rxCharacteristic) == null ? void 0 : _a.removeEventListener(
          "characteristicvaluechanged",
          this.handleCharacteristicChanged
        );
        (_b = this._device) == null ? void 0 : _b.removeEventListener(
          "gattserverdisconnected",
          this.handleDisconnected
        );
  ...
  // src/jdom/transport/jdusb.ts
  var JdUsbProto = class {
    constructor(io) {
      this.io = io;
      this.lock = new PromiseQueue();
      this.frameHandler = (b) => {
      ...
      this.usb_rx_state = 0;
      this.usb_rx_ptr = 0;
      this.rxbuf = new Uint8Array(256);
      this.colorState = "";
      this.serialLineCallback = (line, lineWithColor) => {
      };
    ...
    handleFrame(fr) {
      ...
      if (fr[0] != (c & 255) || fr[1] != c >> 8) {
        this.logError("crc err");
        return;
      }
      if ((fr[3] & JD_FRAME_FLAG_IDENTIFIER_IS_SERVICE_CLASS) != 0 && read32(fr, 4) == SRV_USB_BRIDGE) {
    ...
    processingPkt(serviceCommand) {
      const f = jdpack("u16 u8 u8 u32 u32 u8 u8 u16", [
        0,
        4,
        JD_FRAME_FLAG_IDENTIFIER_IS_SERVICE_CLASS | JD_FRAME_FLAG_COMMAND | JD_FRAME_FLAG_LOOPBACK,
        SRV_USB_BRIDGE,
    ...
    encodeFrame(buf) {
      ...
      const outp = [];
      outp.push(254 /* Magic */);
      outp.push(252 /* FrameStart */);
      for (let ptr = 0; ptr < buf.length; ptr++) {
        const b = buf[ptr];
        outp.push(b);
        if (b == 254 /* Magic */)
          outp.push(248 /* LiteralMagic */);
      }
      outp.push(254 /* Magic */);
      outp.push(253 /* FrameEnd */);
      const res = [];
    ...
    async detectHF2() {
      const pkt_en = this.encodeFrame(
        this.processingPkt(129 /* EnablePackets */)
      )[0];
      const tag0 = 129;
      const tag1 = 66;
    ...
    onSerial(data, iserr) {
      if (this.serialTimeout !== void 0) {
        clearTimeout(this.serialTimeout);
        this.serialTimeout = void 0;
      }
      let start = 0;
      for (let i = 0; i < data.length; ++i) {
    ...
    async postConnectAsync() {
      await this.sendJDMessageAsync(
        this.processingPkt(131 /* EnableLog */)
      );
  ...
  var WebSerialIO = class {
    ...
    async openDeviceAsync() {
      var _a;
      if (!this.dev)
        throwError("device not found", { cancel: true });
      await this.dev.open({
        baudRate: 1e6,
        bufferSize: 32 * 1024
      });
  ...
  var WebUSBTransport = class extends Transport {
    ...
    async transportSendPacketAsync(buf) {
      if (!this.hf2)
  ...
  function defaultOptions2() {
    ...
    return {
      mkTransport: (bus2) => new WebSerialIO(bus2),
      connectObservable,
  ...
  var devices_default = [
    ...
    },
    {
      ...
      relatedDevices: [
        "kittenbot-jacdacstarterkitav10",
    ...
    },
    {
      ...
      firmwares: [
        ...
        },
        {
          ...
          url: "https://github.com/microsoft/jacdac-esp32/releases/latest/download/devicescript-esp32s2.uf2",
          productIdentifier: 1038170507
        },
        {
          name: "Azure IoT Hub Cloud Adapter",
          url: "https://github.com/microsoft/jacdac-esp32/releases/latest/download/devicescript-esp32s2-nojacs.uf2",
    ...
    },
    {
      ...
      devices: [
        ...
        "microsoft-research-jmrgbledbar10v01",
        ...
        "microsoft-research-jmsinglergb-led42v01",
    ...
    },
    {
      ...
      firmwareSource: "https://github.com/microsoft/jacdac-pico",
      connector: "edgeHighCurrentProvider",
      link: "https://github.com/microsoft/jacdac-pico",
      services: [
        530893146,
        414210922,
        411425820,
  ...
  var DeviceCatalog = class extends JDEventSource {
    ...
    specifications(options) {
      const { includeDeprecated, includeExperimental, transport } = options || {};
      ...
      if (transport)
        r = r.filter((d) => {
          var _a;
          return ((_a = d.transport) == null ? void 0 : _a.type) === transport;
        });
      return r;
    }
    ...
    specificationsForService(serviceClass2, options) {
    ...
    vendorIds(type) {
      const ids = this._specifications.filter((spec) => {
        var _a;
      ...
      if (type === "serial") {
        ...
        if (serialVendorIds)
          serialVendorIds.forEach((id) => ids.push(id));
      }
  ...
  // src/servers/devicescriptmanagerserver.ts
  var _DeviceScriptManagerServer = class extends JDServiceServer {
    constructor() {
      super(SRV_DEVICE_SCRIPT_MANAGER);
      this._binary = new Uint8Array(0);
      this.running = this.addRegister(128 /* Running */, [false]);
      this.autoStart = this.addRegister(129 /* Autostart */, [
        true
      ]);
    ...
    setBytecode(binary, debugInfo) {
      ...
      if (hash2 !== valueHash) {
        ...
        this.emit(_DeviceScriptManagerServer.PROGRAM_CHANGE);
        this.emit(CHANGE);
  ...
  var DeviceScriptManagerServer = _DeviceScriptManagerServer;
  DeviceScriptManagerServer.PROGRAM_CHANGE = "programChange";

  // src/servers/planarpositionserver.ts
  var PlanarPositionServer = class extends SensorServer {
    constructor() {
  ...
  var windDirectionOptions = {
    readingValues: [0],
    readingError: [5],
    streamingInterval: 5e3
  };
  var windSpeedOptions = {
    readingValues: [0],
    readingError: [2],
    streamingInterval: 5e3,
    registerValues: [{ code: 261 /* MaxWindSpeed */, values: [80] }]
  };
  var eCO2Options = {
    readingValues: [400],
    streamingInterval: 1e3,
    ...
    return _providerDefinitions = _providerDefinitions || [
      ...
      },
      {
        ...
        services: () => [
          new GamepadServer({
            variant: 4 /* Gamepad */,
            buttonsAvailable: GAMEPAD_ARCADE_BUTTONS | 1024 /* X */ | 2048 /* Y */
          })
        ]
      },
      {
      ...
      },
      {
        ...
        services: () => [
          new JDServiceServer(SRV_LIGHT_BULB, {
            intensityValues: [0],
            isActive: (values) => !!(values == null ? void 0 : values[0]),
  ...
  function fingerPrint() {
    try {
      if (typeof self !== "undefined" && self.localStorage) {
        ...
        const f = self.localStorage[key] || (self.localStorage[key] = randomDeviceId());
        return f;
      }
    } catch (e) {
      return "";
  ...
  function stableSimulatorDeviceId(bus2, template, salt) {
    const fg = fingerPrint();
    const others = bus2.serviceProviders().filter((sp) => sp.template === template);
  ...
  function applyServiceOptions(services, serviceOptions) {
    serviceOptions == null ? void 0 : serviceOptions.forEach(({ serviceClass: serviceClass2, serviceOffset, constants }) => {
      const srvs = services.filter((srv) => srv.serviceClass === serviceClass2);
      const service = srvs[serviceOffset || 0];
      if (!service) {
        console.warn(
          `service provider: service 0x${serviceClass2.toString(
            16
        ...
        Object.entries(constants).forEach(([name, value]) => {
          ...
          if (!spec)
            ...
            if (!reg)
              service.addRegister(spec.identifier, [value]);
            else
              reg.setValues([value]);
          }
        });
  ...
  function addServiceProvider(bus2, definition, serviceOptions) {
    var _a;
    ...
    const salt = bus2.serviceProviderIdSalt;
    const deviceId = stableSimulatorDeviceId(bus2, definition.name, salt);
    const options = {
    ...
    bus2.addServiceProvider(d);
    return d;
  }
  function serviceProviderDefinitionFromServiceClass(serviceClass2) {
    return initProviders().find(
      (provider) => provider.serviceClasses.length === 1 && provider.serviceClasses[0] === serviceClass2
    );
  }

  // src/jdom/clients/rolemanagerclient.ts
  function parentName(bus2, role) {
    var _a;
    if (role.query) {
      const args = role.query.split("&").map((a) => a.split("=", 2));
      const deviceId = (_a = args.find((a) => a[0] === ROLE_QUERY_DEVICE)) == null ? void 0 : _a[1];
      if (deviceId === ROLE_QUERY_SELF_DEVICE)
        return bus2.selfDeviceId;
      return deviceId;
    }
  ...
  function parseRole(role) {
    ...
    if (!specification)
      return void 0;
    const args = (_a = role.query) == null ? void 0 : _a.split("&").map((a) => a.split("=", 2)).filter(([n, v]) => n && v !== void 0).map(([n, v]) => ({ name: n.toLowerCase().trim(), value: v }));
    const serviceOffset = args == null ? void 0 : args.filter((arg) => arg.name === ROLE_QUERY_SERVICE_OFFSET).map((arg) => {
      const i = parseInt(arg.value);
      return isNaN(i) ? void 0 : i;
    })[0];
    const serviceIndex = args == null ? void 0 : args.filter((arg) => arg.name === ROLE_QUERY_SERVICE_INDEX).map((arg) => {
      const i = parseInt(arg.value);
      return isNaN(i) ? void 0 : i;
    })[0];
    const REG_NAME_MAP = {
    ...
    const pktArgs = (_b = args == null ? void 0 : args.map(({ name, value }) => ({
      name: REG_NAME_MAP[name] || name,
      value
    }))) == null ? void 0 : _b.map(({ name, value }) => ({
      name,
      value,
      ...
      var _a2;
      return !!((_a2 = a.pkt) == null ? void 0 : _a2.packFormat);
    }).map(({ name, value, pkt }) => {
      var _a2;
      let simpleValue;
      const type = pkt.fields[0].type;
      const enumType = (_a2 = specification.enums) == null ? void 0 : _a2[type];
      if (enumType)
        simpleValue = enumType.members[value] || parseInt(value);
      else if (type == "string")
        simpleValue = value;
      else
        simpleValue = parseInt(value);
      return { name, value: simpleValue };
    });
    if (serviceOffset === void 0 && serviceIndex === void 0 && !(pktArgs == null ? void 0 : pktArgs.length))
      return void 0;
    const constants = pktArgs && toMap(
      pktArgs,
      (a) => a.name,
      (a) => a.value
    );
  ...
  var RoleManagerClient = class extends JDServiceClient {
    constructor(service) {
      super(service);
      this._roles = [];
    ...
    async collectRoles() {
      ...
      try {
        ...
        await this.service.sendPacketAsync(
          inp.openCommand(131 /* ListRoles */),
          true
        );
        const roles = [];
        for (const buf of await inp.readData(1500)) {
          const [devidbuf, serviceClass2, serviceIndex, full] = jdunpack(buf, "b[8] u32 u8 s");
    ...
    assignRoles() {
      this.bus.services().filter((srv) => !isInfrastructure(srv.specification)).forEach((srv) => this.assignRole(srv));
    }
    assignRole(service) {
      ...
      if (service.role !== (role == null ? void 0 : role.name))
        this.log(`role ${service} -> ${(role == null ? void 0 : role.name) || ""}`, { role });
        ...
        if (!parent) {
          todo.forEach((t) => {
            ...
            addServiceProvider(
              this.bus,
              t.hostDefinition,
              serviceOptions ? [serviceOptions] : void 0
            );
          });
        } else {
          addServiceProvider(
  ...
  // src/jdom/bus.ts
  var JDBus2 = class extends JDNode {
    constructor(transports, options) {
      ...
      this._interactionMode = 0 /* Active */;
    ...
    configureBroadcastChannel() {
      if (typeof BroadcastChannel === "undefined" || typeof self === "undefined" || this._unsubscribeBroadcastChannel)
        return;
      ...
      this._postBroadcastMessage = (event, msg) => {
        const bmsg = {
          id: this.selfDevice.shortId,
          event,
          ...msg || {}
      ...
      const handleVisibilityChange = () => this._postBroadcastMessage("visibilitychange", {
      ...
      const handleBroadcastMessage = async (msg) => {
        ...
        switch (event) {
          ...
          case "connectionstate": {
            ...
            transports.filter(
              (tr) => tr.connectionState === "connecting" /* Connecting */
            ).forEach((ctr) => {
    ...
    broadcastDisconnectRequest() {
      var _a;
      (_a = this._postBroadcastMessage) == null ? void 0 : _a.call(this, "disconnect", {});
    }
    get client() {
      return this._client;
    }
    ...
    set autoConnect(value) {
      if (value !== this._autoConnect) {
        ...
        this.emit(CHANGE);
        if (this.disconnected && this._autoConnect && typeof document !== "undefined" && document.visibilityState === "visible")
          this.connect(true);
      }
    }
    get bridges() {
    ...
    get passive() {
      return this._interactionMode === 2 /* Passive */;
    }
    set passive(value) {
      this.interactionMode = value ? 2 /* Passive */ : 0 /* Active */;
    }
    get interactionMode() {
    ...
    preConnect(transport) {
      return Promise.all(
        this._transports.filter((t) => t !== transport).map((t) => t.disconnect())
      );
    }
    ...
    async stop() {
      ...
      if (this._unsubscribeBroadcastChannel) {
        this._postBroadcastMessage = void 0;
        this._unsubscribeBroadcastChannel();
...
bridges:
${(_a = this._bridges) == null ? void 0 : _a.map(
        (tr) => `  ${tr.bridgeId}: recv ${tr.packetProcessed}, sent ${tr.packetSent}`
      ).join("\n")}

${this.devices({ ignoreInfrastructure: false }).map(
        (dev) => {
          var _a2;
          return `device: 
  id: ${dev.shortId} (0x${dev.deviceId})
  product: ${dev.name || "?"} (0x${((_a2 = dev.productIdentifier) == null ? void 0 : _a2.toString(16)) || "?"})
  firmware_version: ${dev.firmwareVersion || ""}
  uptime: ${dev.uptime || ""}
  stats: ${dev.stats.toString()}
  services:
${dev.services().slice(1).map(
            (srv) => {
              var _a3;
              return [
                `    ${((_a3 = srv.specification) == null ? void 0 : _a3.shortName) || srv.name} (0x${srv.serviceClass.toString(16)})`,
                ...srv.registers().filter((reg) => !!reg.data).map(
                  (reg) => {
                    var _a4;
                    return `        ${((_a4 = reg.specification) == null ? void 0 : _a4.kind) || "reg"} ${reg.name}${reg.needsRefresh ? "*" : ""}: ${reg.humanValue} (${toHex(reg.data)}) ${reg.notImplemented ? "- not implemented" : ""}
            last data: ${reg.lastDataTimestamp || ""}, last get: ${reg.lastGetTimestamp || ""}, last set: ${reg.lastSetTimestamp || ""}, last gets attempts: ${reg.lastGetAttempts},`;
                  }
                ),
...
`;
    ...
    delay(millis, value) {
      return new Promise(
        (resolve) => this.scheduler.setTimeout(() => resolve(value), millis)
      );
    }
    ...
    async sendFrameAsync(frame) {
      if (frame._jacdac_timestamp === void 0)
        frame._jacdac_timestamp = this.timestamp;
      this.emit(FRAME_SEND, frame);
      this.processFrame(frame, frame._jacdac_sender);
      await Promise.all(
        this._transports.map(
          (transport) => transport.sendPacketWhenConnectedAsync(frame)
        )
      );
    }
    ...
    devices(options) {
      ...
      if (options == null ? void 0 : options.ignoreInfrastructure)
        r = r.filter(
          (s) => s.deviceId !== this.selfDeviceId && s.serviceClasses.indexOf(SRV_INFRASTRUCTURE) < 0
        );
    ...
    device(id, skipCreate, pkt) {
      ...
      if (!d && !skipCreate) {
        ...
        if (Flags.diagnostics)
          console.debug(
            `${id === this.selfDeviceId ? "self" : "new"} device ${d.shortId} (${id})`
          );
    ...
    processPacket(pkt) {
      ...
      if (!frame._jacdac_timestamp)
        frame._jacdac_timestamp = this.timestamp;
      this.emit(FRAME_PROCESS, pkt.toBuffer());
      this.processPacketCore(pkt);
    }
    processFrame(frame, sender, skipCrc = false) {
      if (sender)
        frame._jacdac_sender = sender;
      if (frame._jacdac_timestamp === void 0)
        frame._jacdac_timestamp = this.timestamp;
      ...
      for (const pkt of Packet.fromFrame(
        ...
        if (frame._jacdac_replay)
          pkt.replay = true;
        this.processPacketCore(pkt);
      }
    }
    processPacketCore(pkt) {
    ...
    async sendResetIn() {
      ...
      if (!this.devices({ ignoreInfrastructure: true }).length)
        return;
      this._lastResetInTime = this.timestamp;
      const rst = Packet.jdpacked(
        CMD_SET_REG | 128 /* ResetIn */,
        "u32",
        [RESET_IN_TIME_US]
      );
    ...
    async sendStopStreaming() {
      const readingRegisters = this.services({
        ...
        (srv) => srv.readingRegister && srv.register(3 /* StreamingSamples */)
      ).filter((reg) => !!reg);
      await Promise.all(
    ...
    handleRefreshRegisters() {
      if (this.interactionMode !== 0 /* Active */)
        return;
      const devices = this._devices.filter(
        (device) => device.announced && !device.lost && !device.firmwareUpdater
      );
      if (!devices.length)
        return;
      const registers = arrayConcatMany(
        devices.map(
          (device) => arrayConcatMany(
            device.services({ specification: true }).map(
              (service) => service.registers().filter((reg) => !reg.notImplemented).filter(
                (reg) => this._streaming && reg.code === 257 /* Reading */ || reg.needsRefresh || reg.listenerCount(REPORT_RECEIVE) > 0 || reg.listenerCount(REPORT_UPDATE) > 0
              ).filter(
                (reg) => !reg.data || !(isConstRegister(reg.specification) || reg.code === 262 /* ReadingError */)
              ).filter(
                (reg) => {
                  var _a;
      ...
      for (const register of registers) {
        ...
        if (register.needsRefresh && lastGetAttempts == 0) {
          ...
          const expiration = volatile ? Math.min(
            REGISTER_POLL_REPORT_VOLATILE_MAX_INTERVAL,
            REGISTER_POLL_REPORT_VOLATILE_INTERVAL * (1 << backoff)
          ) : Math.min(
            REGISTER_POLL_REPORT_MAX_INTERVAL,
            (noDataYet ? REGISTER_POLL_FIRST_REPORT_INTERVAL : REGISTER_POLL_REPORT_INTERVAL) * (1 << backoff)
          );
          if (age > expiration) {
            register.sendGetAsync();
          }
  ...
  function createConnectButton() {
    if (!connectBtn && isWebTransportSupported()) {
      ...
      bus.on(
        CONNECTION_STATE,
        () => bus.connected ? connectBtn == null ? void 0 : connectBtn.hide() : connectBtn == null ? void 0 : connectBtn.show()
      );
      if (bus.connected) {
        connectBtn == null ? void 0 : connectBtn.hide();
        devtoolsBtn == null ? void 0 : devtoolsBtn.hide();
      }
    }
    return connectBtn;
  }
  ...
  var events = toMap(
    ...
    (spec) => toMap(
      ...
      (pkt) => pkt.name,
      (pkt) => (handler) => bus.on(EVENT, (ev) => {
        if (ev.service.serviceClass === spec.classIdentifier && ev.code === pkt.identifier)
          handler(ev);
      })
    )
  );
  ...
  return __toCommonJS(p5_jacdac_exports);
})();
//# sourceMappingURL=p5.jacdac.js.map
