export declare const CONST_SYSTEM_ANNOUNCE_INTERVAL = 500;
export declare enum SystemReadingThreshold {
    Neutral = 1,
    Inactive = 2,
    Active = 3
}
export declare enum SystemStatusCodes {
    Ready = 0,
    Initializing = 1,
    Calibrating = 2,
    Sleeping = 3,
...
export declare const SRV_ACCELEROMETER = 521405449;
export declare enum AccelerometerReg {
    /**
     ...
     * ```
     */
    MaxForcesSupported = 266
}
export declare enum AccelerometerEvent {
    /**
...
export declare const SRV_ACIDITY = 513243333;
export declare enum AcidityReg {
    /**
...
export declare const SRV_AIR_PRESSURE = 504462570;
export declare enum AirPressureReg {
    /**
...
export declare const SRV_AIR_QUALITY_INDEX = 346844886;
export declare enum AirQualityIndexReg {
    /**
...
export declare const SRV_ARCADE_GAMEPAD = 501915758;
export declare enum ArcadeGamepadButton {
    Left = 1,
    Up = 2,
    Right = 3,
    Down = 4,
...
export declare enum ArcadeGamepadReg {
    /**
...
export declare enum ArcadeGamepadEvent {
    /**
...
export declare const SRV_ARCADE_SOUND = 533083654;
export declare enum ArcadeSoundCmd {
    /**
...
export declare enum ArcadeSoundReg {
    /**
...
export declare const SRV_BARCODE_READER = 477339244;
export declare enum BarcodeReaderFormat {
    Aztec = 1,
    Code128 = 2,
    Code39 = 3,
    Code93 = 4,
...
export declare enum BarcodeReaderReg {
    /**
...
export declare enum BarcodeReaderEvent {
    /**
...
export declare const SRV_BIT_RADIO = 449414863;
export declare enum BitRadioReg {
    /**
...
export declare enum BitRadioCmd {
    /**
...
export declare const SRV_BOOTLOADER = 536516936;
export declare enum BootloaderError {
    NoError = 0,
    PacketTooSmall = 1,
...
export declare enum BootloaderCmd {
    /**
...
export declare const SRV_BRAILLE_DISPLAY = 331331532;
export declare enum BrailleDisplayReg {
    /**
...
export declare const SRV_BRIDGE = 535147631;
export declare enum BridgeReg {
    /**
...
export declare const SRV_BUTTON = 343122531;
export declare enum ButtonReg {
    /**
...
export declare const SRV_BUZZER = 458731991;
export declare enum BuzzerReg {
    /**
...
export declare const SRV_CAPACITIVE_BUTTON = 677752265;
export declare enum CapacitiveButtonReg {
    /**
...
export declare enum CapacitiveButtonCmd {
    /**
...
export declare const SRV_CHARACTER_SCREEN = 523748714;
export declare enum CharacterScreenVariant {
    LCD = 1,
    OLED = 2,
    Braille = 3
}
export declare enum CharacterScreenTextDirection {
    LeftToRight = 1,
    RightToLeft = 2
}
export declare enum CharacterScreenReg {
    /**
...
export declare const SRV_CLOUD_ADAPTER = 341864092;
export declare enum CloudAdapterCommandStatus {
    OK = 200,
    NotFound = 404,
    Busy = 429
}
export declare enum CloudAdapterCmd {
    /**
...
export declare enum CloudAdapterReg {
    /**
...
export declare enum CloudAdapterEvent {
    /**
...
export declare const SRV_CLOUD_CONFIGURATION = 342028028;
export declare enum CloudConfigurationConnectionStatus {
    Connected = 1,
    Disconnected = 2,
    Connecting = 3,
    Disconnecting = 4
}
export declare enum CloudConfigurationReg {
    /**
     ...
     * ```
     */
    PushWatchdogPeriod = 129
}
export declare enum CloudConfigurationCmd {
    /**
     ...
     * ```
     */
    SetConnectionString = 134
}
export declare enum CloudConfigurationEvent {
    /**
...
export declare const SRV_CODAL_MESSAGE_BUS = 304085021;
export declare enum CodalMessageBusCmd {
    /**
...
export declare enum CodalMessageBusEvent {
    /**
...
export declare const SRV_COLOR = 372299111;
export declare enum ColorReg {
    /**
...
export declare const SRV_COMPASS = 364362175;
export declare enum CompassReg {
    /**
...
export declare enum CompassCmd {
    /**
     * No args. Starts a calibration sequence for the compass.
     */
    Calibrate = 2
}
export declare const SRV_CONTROL = 0;
export declare enum ControlAnnounceFlags {
...
export declare enum ControlCmd {
    /**
 ...
 * ```
 */
export declare enum ControlReg {
    /**
     ...
     * ```
     */
    BootloaderProductIdentifier = 388,
    /**
...
export declare const SRV_DASHBOARD = 468029703;
export declare const SRV_DC_CURRENT_MEASUREMENT = 420661422;
export declare enum DcCurrentMeasurementReg {
    /**
...
export declare const SRV_DC_VOLTAGE_MEASUREMENT = 372485145;
export declare enum DcVoltageMeasurementVoltageMeasurementType {
    Absolute = 0,
    Differential = 1
}
export declare enum DcVoltageMeasurementReg {
    /**
...
export declare const SRV_DEVICE_SCRIPT_CONDITION = 295074157;
export declare enum DeviceScriptConditionCmd {
    /**
     * No args. Triggers a `signalled` event.
     */
    Signal = 128
}
export declare enum DeviceScriptConditionEvent {
    /**
     * Triggered by `signal` command.
     */
    Signalled = 3
}
export declare const SRV_DEVICE_SCRIPT_MANAGER = 288680491;
export declare enum DeviceScriptManagerMessageFlags {
    ToBeContinued = 1
}
export declare enum DeviceScriptManagerCmd {
    /**
 ...
 * ```
 */
export declare enum DeviceScriptManagerReg {
    /**
...
export declare enum DeviceScriptManagerEvent {
    /**
...
export declare const SRV_DISTANCE = 337275786;
export declare enum DistanceVariant {
    Ultrasonic = 1,
    Infrared = 2,
    LiDAR = 3,
    Laser = 4
}
export declare enum DistanceReg {
    /**
...
export declare const SRV_DMX = 298814469;
export declare enum DmxReg {
    /**
...
export declare const SRV_DOT_MATRIX = 286070091;
export declare enum DotMatrixVariant {
    LED = 1,
    Braille = 2
}
export declare enum DotMatrixReg {
    /**
...
export declare const SRV_DUAL_MOTORS = 355063095;
export declare enum DualMotorsReg {
    /**
...
export declare const SRV_E_CO2 = 379362758;
export declare enum ECO2Variant {
    VOC = 1,
    NDIR = 2
}
export declare enum ECO2Reg {
    /**
...
export declare const SRV_FLEX = 524797638;
export declare enum FlexReg {
    /**
...
export declare const SRV_GAMEPAD = 277836886;
export declare enum GamepadButtons {
    Left = 1,
    Up = 2,
    Right = 4,
    Down = 8,
...
export declare enum GamepadVariant {
    Thumb = 1,
    ArcadeBall = 2,
    ArcadeStick = 3,
    Gamepad = 4
}
export declare enum GamepadReg {
    /**
     ...
     * ```
     */
    ButtonsAvailable = 384
}
export declare enum GamepadEvent {
    /**
...
export declare const SRV_GYROSCOPE = 505087730;
export declare enum GyroscopeReg {
    /**
     ...
     * ```
     */
    MaxRatesSupported = 266
}
export declare const SRV_HEART_RATE = 376204740;
export declare enum HeartRateVariant {
    Finger = 1,
    Chest = 2,
    Wrist = 3,
    Pump = 4,
...
export declare enum HeartRateReg {
    /**
...
export declare const SRV_HID_JOYSTICK = 437330261;
export declare enum HidJoystickReg {
    /**
...
export declare enum HidJoystickCmd {
    /**
...
export declare const SRV_HID_KEYBOARD = 414210922;
export declare enum HidKeyboardSelector {
    None = 0,
    ErrorRollOver = 1,
    PostFail = 2,
    ErrorUndefined = 3,
...
export declare enum HidKeyboardModifiers {
    None = 0,
    LeftControl = 1,
    LeftShift = 2,
    LeftAlt = 4,
...
export declare enum HidKeyboardAction {
    Press = 0,
    Up = 1,
    Down = 2
}
export declare enum HidKeyboardCmd {
    /**
...
export declare const SRV_HID_MOUSE = 411425820;
export declare enum HidMouseButton {
    Left = 1,
    Right = 2,
    Middle = 4
}
export declare enum HidMouseButtonEvent {
    Up = 1,
    Down = 2,
    Click = 3,
    DoubleClick = 4
}
export declare enum HidMouseCmd {
    /**
...
export declare const SRV_HUMIDITY = 382210232;
export declare enum HumidityReg {
    /**
...
export declare const SRV_ILLUMINANCE = 510577394;
export declare enum IlluminanceReg {
    /**
     ...
     * ```
     */
    IlluminanceError = 262
}
export declare const SRV_INDEXED_SCREEN = 385496805;
export declare enum IndexedScreenCmd {
    /**
...
export declare enum IndexedScreenReg {
    /**
...
export declare const SRV_INFRASTRUCTURE = 504728043;
export declare const SRV_LED = 369743088;
export declare const CONST_LED_MAX_PIXELS_LENGTH = 64;
export declare enum LedVariant {
    Strip = 1,
    Ring = 2,
    Stick = 3,
    Jewel = 4,
...
export declare const SRV_LED_SINGLE = 506480888;
export declare enum LedSingleVariant {
    ThroughHole = 1,
    SMD = 2,
    Power = 3,
    Bead = 4
}
export declare enum LedSingleCmd {
    /**
...
export declare enum LedSingleReg {
    /**
...
export declare const SRV_LED_STRIP = 309264608;
export declare enum LedStripLightType {
    WS2812B_GRB = 0,
    APA102 = 16,
    SK9822 = 17
}
export declare enum LedStripVariant {
    Strip = 1,
    Ring = 2,
    Stick = 3,
    Jewel = 4,
...
export declare enum LedStripReg {
    /**
     * Read-write ratio u0.8 (uint8_t). Set the luminosity of the strip.
     * At `0` the power to the strip is completely shut down.
     *
...
export declare enum LedStripCmd {
    /**
...
export declare const SRV_LIGHT_BULB = 480970060;
export declare enum LightBulbReg {
    /**
...
export declare const SRV_LIGHT_LEVEL = 400333340;
export declare enum LightLevelVariant {
    PhotoResistor = 1,
    ReverseBiasedLED = 2
}
export declare enum LightLevelReg {
    /**
...
export declare const SRV_LOGGER = 316415946;
export declare enum LoggerPriority {
    Debug = 0,
    Log = 1,
    Warning = 2,
    Error = 3,
...
export declare const SRV_MAGNETIC_FIELD_LEVEL = 318642191;
export declare enum MagneticFieldLevelVariant {
    AnalogNS = 1,
    AnalogN = 2,
    AnalogS = 3,
    DigitalNS = 4,
...
export declare enum MagneticFieldLevelReg {
    /**
...
export declare enum MagneticFieldLevelEvent {
    /**
...
export declare const SRV_MAGNETOMETER = 318935176;
export declare enum MagnetometerReg {
    /**
...
export declare enum MagnetometerCmd {
    /**
...
export declare const SRV_MATRIX_KEYPAD = 319172040;
export declare enum MatrixKeypadVariant {
    Membrane = 1,
    Keyboard = 2,
    Elastomer = 3,
    ElastomerLEDPixel = 4
}
export declare enum MatrixKeypadReg {
    /**
...
export declare enum MatrixKeypadEvent {
    /**
...
export declare const SRV_MICROPHONE = 289254534;
export declare enum MicrophoneCmd {
    /**
...
export declare enum MicrophoneReg {
    /**
...
export declare const SRV_MIDI_OUTPUT = 444894423;
export declare enum MidiOutputReg {
    /**
...
export declare enum MidiOutputCmd {
    /**
...
export declare const SRV_MODEL_RUNNER = 336566904;
export declare enum ModelRunnerModelFormat {
    TFLite = 860636756,
    ML4F = 809963362,
    EdgeImpulseCompiled = 810961221
}
export declare enum ModelRunnerCmd {
    /**
...
export declare enum ModelRunnerReg {
    /**
...
export declare const SRV_MOTION = 293185353;
export declare enum MotionVariant {
    PIR = 1
}
export declare enum MotionReg {
    /**
...
export declare const SRV_MOTOR = 385895640;
export declare enum MotorReg {
    /**
...
export declare const SRV_MULTITOUCH = 487664309;
export declare enum MultitouchReg {
    /**
...
export declare enum MultitouchEvent {
    /**
...
export declare const SRV_PLANAR_POSITION = 499351381;
export declare enum PlanarPositionVariant {
    OpticalMousePosition = 1
}
export declare enum PlanarPositionReg {
    /**
...
export declare const SRV_POTENTIOMETER = 522667846;
export declare enum PotentiometerVariant {
    Slider = 1,
    Rotary = 2
}
export declare enum PotentiometerReg {
    /**
...
export declare const SRV_POWER = 530893146;
export declare enum PowerPowerStatus {
    Disallowed = 0,
    Powering = 1,
    Overload = 2,
    Overprovision = 3
}
export declare enum PowerReg {
    /**
...
export declare const SRV_POWER_SUPPLY = 524302175;
export declare enum PowerSupplyReg {
    /**
...
export declare const SRV_PRESSURE_BUTTON = 672612547;
export declare enum PressureButtonReg {
    /**
     * Read-write ratio u0.16 (uint16_t). Indicates the threshold for ``up`` events.
     *
     * ```
...
export declare const SRV_PROTO_TEST = 382158442;
export declare enum ProtoTestReg {
    /**
...
export declare enum ProtoTestEvent {
    /**
...
export declare enum ProtoTestCmd {
    /**
 ...
 * ```
 */
export declare const SRV_PROXY = 384932169;
export declare const SRV_PULSE_OXIMETER = 280710838;
export declare enum PulseOximeterReg {
    /**
...
export declare const SRV_RAIN_GAUGE = 326323349;
export declare enum RainGaugeReg {
    /**
...
export declare const SRV_REAL_TIME_CLOCK = 445323816;
export declare enum RealTimeClockVariant {
    Computer = 1,
    Crystal = 2,
    Cuckoo = 3
}
export declare enum RealTimeClockReg {
    /**
...
export declare enum RealTimeClockCmd {
    /**
...
export declare const SRV_REFLECTED_LIGHT = 309087410;
export declare enum ReflectedLightVariant {
    InfraredDigital = 1,
    InfraredAnalog = 2
}
export declare enum ReflectedLightReg {
    /**
...
export declare const SRV_RELAY = 406840918;
export declare enum RelayVariant {
    Electromechanical = 1,
    SolidState = 2,
    Reed = 3
}
export declare enum RelayReg {
    /**
...
export declare const SRV_RNG = 394916002;
export declare enum RngVariant {
    Quantum = 1,
    ADCNoise = 2,
    WebCrypto = 3
}
export declare enum RngReg {
    /**
...
export declare const SRV_ROLE_MANAGER = 508264038;
export declare enum RoleManagerReg {
    /**
...
export declare enum RoleManagerCmd {
    /**
 ...
 * ```
 */
export declare enum RoleManagerEvent {
    /**
     * Notifies that role bindings have changed.
     */
    Change = 3
}
export declare const SRV_ROTARY_ENCODER = 284830153;
export declare enum RotaryEncoderReg {
    /**
...
export declare const SRV_ROVER = 435474539;
export declare enum RoverReg {
    /**
...
export declare const SRV_SAT_NAV = 433938742;
export declare enum SatNavReg {
    /**
...
export declare enum SatNavEvent {
    /**
     * The module is disabled or lost connection with satellites.
     */
    Inactive = 2
}
export declare const SRV_SENSOR_AGGREGATOR = 496034245;
export declare enum SensorAggregatorSampleType {
    U8 = 8,
    I8 = 136,
    U16 = 16,
    I16 = 144,
...
export declare enum SensorAggregatorReg {
    /**
...
export declare const SRV_SERVO = 318542083;
export declare enum ServoReg {
    /**
...
export declare const SRV_SETTINGS = 285727818;
export declare enum SettingsCmd {
    /**
...
export declare const SRV_SEVEN_SEGMENT_DISPLAY = 425810167;
export declare enum SevenSegmentDisplayReg {
    /**
...
export declare enum SevenSegmentDisplayCmd {
    /**
     * Argument: value f64 (uint64_t). Shows the number on the screen using the decimal dot if available.
     */
    SetNumber = 128
}
export declare const SRV_SOIL_MOISTURE = 491430835;
export declare enum SoilMoistureVariant {
    Resistive = 1,
    Capacitive = 2
}
export declare enum SoilMoistureReg {
    /**
...
export declare const SRV_SOLENOID = 387392458;
export declare enum SolenoidVariant {
    PushPull = 1,
    Valve = 2,
    Latch = 3
}
export declare enum SolenoidReg {
    /**
...
export declare const SRV_SOUND_LEVEL = 346888797;
export declare enum SoundLevelReg {
    /**
...
export declare enum SoundLevelEvent {
    /**
...
export declare const SRV_SOUND_PLAYER = 335795000;
export declare enum SoundPlayerReg {
    /**
...
export declare enum SoundPlayerCmd {
    /**
 ...
 * ```
 */
export declare const SRV_SOUND_RECORDER_WITH_PLAYBACK = 460504912;
export declare enum SoundRecorderWithPlaybackStatus {
    Idle = 0,
    Recording = 1,
    Playing = 2
}
export declare enum SoundRecorderWithPlaybackCmd {
    /**
...
export declare enum SoundRecorderWithPlaybackReg {
    /**
...
export declare const SRV_SOUND_SPECTRUM = 360365086;
export declare enum SoundSpectrumReg {
    /**
     ...
     * ```
     */
    SmoothingTimeConstant = 131
}
export declare const SRV_SPEECH_SYNTHESIS = 302307733;
export declare enum SpeechSynthesisReg {
    /**
...
export declare enum SpeechSynthesisCmd {
    /**
...
export declare const SRV_SWITCH = 450008066;
export declare enum SwitchVariant {
    Slide = 1,
    Tilt = 2,
    PushButton = 3,
    Tactile = 4,
...
export declare enum SwitchEvent {
    /**
...
export declare const SRV_TCP = 457422603;
export declare enum TcpTcpError {
    InvalidCommand = 1,
    InvalidCommandPayload = 2
}
export declare enum TcpCmd {
    /**
...
export declare enum TcpPipeCmd {
    /**
 ...
 * ```
 */
export declare const SRV_TEMPERATURE = 337754823;
export declare enum TemperatureVariant {
    Outdoor = 1,
    Indoor = 2,
    Body = 3
}
export declare enum TemperatureReg {
    /**
...
export declare const SRV_TIMESERIES_AGGREGATOR = 294829516;
export declare enum TimeseriesAggregatorCmd {
    /**
...
export declare enum TimeseriesAggregatorReg {
    /**
     ...
     * ```
     */
    SensorWatchdogPeriod = 132
}
export declare const SRV_TRAFFIC_LIGHT = 365137307;
export declare enum TrafficLightReg {
    /**
...
export declare const SRV_TVOC = 312849815;
export declare enum TvocReg {
    /**
...
export declare const SRV_UNIQUE_BRAIN = 272387813;
export declare const SRV_USB_BRIDGE = 418781770;
export declare enum UsbBridgeQByte {
    Magic = 254,
    LiteralMagic = 248,
    Reserved = 249,
    SerialGap = 250,
...
export declare enum UsbBridgeCmd {
    /**
...
export declare const SRV_UV_INDEX = 527306128;
export declare enum UvIndexVariant {
    UVA_UVB = 1,
    Visible_IR = 2
}
export declare enum UvIndexReg {
    /**
...
export declare const SRV_VERIFIED_TELEMETRY = 563381279;
export declare enum VerifiedTelemetryStatus {
    Unknown = 0,
    Working = 1,
    Faulty = 2
}
export declare enum VerifiedTelemetryFingerprintType {
    FallCurve = 1,
    CurrentSense = 2,
    Custom = 3
}
export declare enum VerifiedTelemetryReg {
    /**
     ...
     * ```
     */
    FingerprintTemplate = 386
}
export declare enum VerifiedTelemetryCmd {
    /**
     ...
     */
    RetrainFingerprintTemplate = 129
}
export declare enum VerifiedTelemetryEvent {
    /**
     ...
     * ```
     */
    TelemetryStatusChange = 3,
    /**
     * The fingerprint template was updated
     */
    FingerprintTemplateChange = 128
}
export declare const SRV_VIBRATION_MOTOR = 406832290;
export declare enum VibrationMotorCmd {
    /**
...
export declare enum VibrationMotorReg {
    /**
...
export declare const SRV_WATER_LEVEL = 343630573;
export declare enum WaterLevelVariant {
    Resistive = 1,
    ContactPhotoElectric = 2,
    NonContactPhotoElectric = 3
}
export declare enum WaterLevelReg {
    /**
...
export declare const SRV_WEIGHT_SCALE = 525160512;
export declare enum WeightScaleVariant {
    Body = 1,
    Food = 2,
    Jewelry = 3
}
export declare enum WeightScaleReg {
    /**
...
export declare enum WeightScaleCmd {
    /**
...
export declare const SRV_WIFI = 413852154;
export declare enum WifiAPFlags {
    HasPassword = 1,
    WPS = 2,
...
export declare enum WifiEvent {
     ...
     * ```
     */
    ConnectionFailed = 130
}
export declare const SRV_WIND_DIRECTION = 409725227;
export declare enum WindDirectionReg {
    /**
...
export declare const SRV_WIND_SPEED = 458824639;
export declare enum WindSpeedReg {
    /**
