 ...
 * @internal
 */
export declare const SG90_RESPONSE_SPEED = 0.12;
/**
 ...
 * @category Servers
 */
export default function serviceProviderDefinitions(): ServiceProviderDefinition[];
/**
 * Instantiates a new service provider instance and adds it to the bus
 * @category Servers
 */
export declare function addServiceProvider(bus: JDBus, definition: ServiceProviderDefinition): JDServiceProvider;
/**
 * Finds the first service provider that supports the given service class
 * @category Servers
 */
export declare function serviceProviderDefinitionFromServiceClass(serviceClass: number): ServiceProviderDefinition;
/**
 * Starts a service provider that hosts the given service class.
 * @category Servers
 */
export declare function startServiceProviderFromServiceClass(bus: JDBus, serviceClass: number): JDServiceProvider;
