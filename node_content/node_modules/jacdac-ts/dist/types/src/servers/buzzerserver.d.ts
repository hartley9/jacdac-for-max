 ...
 */
export declare function tonePayload(frequency: number, ms: number, volume: number): Uint8Array;
/**
 * Server implementation for the buzzer service
 * @category Servers
 */
export declare class BuzzerServer extends JDServiceServer {
    readonly volume: JDRegisterServer<[number]>;
    static PLAY_TONE: string;
    constructor(options?: JDServerOptions);
    private handlePlayTone;
}
//# sourceMappingURL=buzzerserver.d.ts.map