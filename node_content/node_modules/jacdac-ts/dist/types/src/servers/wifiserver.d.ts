import { WifiAPFlags } from "../jdom/constants";
...
export declare class WifiServer extends JDServiceServer {
    ...
    private scan;
    private handleScan;
    private handleLastScanResults;
    private handleListKnownNetworks;
    private handleAddNetwork;
    private handleForgetAllNetworks;
    private handleForgetNetwork;
    private handleSetNetworkPriority;
}
export default WifiServer;
//# sourceMappingURL=wifiserver.d.ts.map