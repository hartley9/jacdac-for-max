 ...
 * @internal
 */
export interface SensorServiceOptions<TReading extends PackedValues> extends JDServerOptions {
...
export default class SensorServer<TReading extends PackedValues> extends JDServiceServer {
    ...
    private lastStream;
    private lastErrorReadingChanged;
    constructor(serviceClass: number, options?: SensorServiceOptions<TReading>);
    private refreshRegisters;
}
//# sourceMappingURL=sensorserver.d.ts.map