 ...
 */
export declare type PackedSimpleValue = number | boolean | string | Uint8Array;
/**
 * @category Data Packing
 */
export declare type PackedValues = any[];
/**
 Unpacks a byte buffer into structured data as specified in the format string.
 See jdpack for format string reference.
 @category Data Packing
*/
export declare function jdunpack<T extends PackedValues>(buf: Uint8Array, fmt: string): T;
/**
...
* @category Data Packing
*/
export declare function jdpack<T extends PackedValues>(fmt: string, data: T): Uint8Array;
/**
 ...
 * @category Data Packing
 */
export declare function jdpackEqual<T extends PackedValues>(fmt: string, left: T, right: T): boolean;
