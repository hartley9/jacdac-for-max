...
export declare const USB_FILTERS: {
    filters: ({
        classCode: number;
        subclassCode: number;
        vendorId?: undefined;
...
export default class USBIO implements HF2_IO {
    ...
    connectAsync(background: boolean, deviceId?: string): Promise<Proto>;
    private openDeviceAsync;
}
//# sourceMappingURL=usbio.d.ts.map