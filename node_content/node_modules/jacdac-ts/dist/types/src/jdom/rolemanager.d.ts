 ...
 * @category Roles
 */
export declare class RoleManager extends JDClient {
     ...
     */
    roles(bound?: boolean): LiveRoleBinding[];
    /**
     * Saves roles status
     * @returns
     */
     ...
     * @param newRoles
     */
    updateRoles(newRoles: RoleBinding[]): void;
    /**
     * Resolves the service bound to a given role.
     * @param role
     * @returns
     */
    service(role: string): JDService;
    /**
     ...
     * @returns
     */
    updateRole(role: string, serviceClass: number, preferredDeviceId?: string, preferredServiceIndex?: number): void;
    private emitBoundEvents;
    private bindRole;
 ...
 * @category Roles
 */
export declare function startRoles<TRoles extends Record<string, {
    serviceClass: number;
    preferredDeviceId?: string;
    preferredServiceIndex?: number;
}>>(bus: JDBus, bindings: TRoles, onUpdate: (roles: Record<keyof TRoles, JDService>) => void, options?: {
    /**
