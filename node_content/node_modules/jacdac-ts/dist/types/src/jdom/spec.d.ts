 ...
 */
export declare function loadServiceSpecifications(specs: jdspec.ServiceSpec[]): void;
/**
 * Adds a custom service specification
 * @param service
 * @category Specification
 */
export declare function addCustomServiceSpecification(service: jdspec.ServiceSpec): void;
/**
 * Clears any custom service specification
 * @category Specification
 */
export declare function clearCustomServiceSpecifications(): void;
/**
 * Returns a map from service short ids to service specifications
 * @category Specification
 */
export declare function serviceMap(): Record<string, jdspec.ServiceSpec>;
/**
 ...
 * @internal
 */
export declare function identifierToUrlPath(id: string): string;
/**
 ...
 * @internal
 */
export declare function numberFormatToStorageType(nf: NumberFormat): 8 | 1 | 2 | 4 | -1 | -2 | -4 | -8;
/**
 * @internal
 */
