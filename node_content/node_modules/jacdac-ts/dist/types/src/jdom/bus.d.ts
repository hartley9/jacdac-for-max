...
import { LoggerPriority } from "../../src/jdom/constants";
 ...
 * @category JDOM
 */
export declare class JDBus extends JDNode {
    /**
     * @internal
     */
    ...
    private _devices;
    private _gcInterval;
    private _announceInterval;
    private _safeBootInterval;
    private _refreshRegistersInterval;
    private _lastPingLoggerTime;
    private _lastResetInTime;
    private _restartCounter;
    private _roleManagerClient;
    private _minLoggerPriority;
    private _firmwareBlobs;
    private _gcDevicesFrozen;
    private _serviceProviders;
    private _unsubscribeBroadcastChannel;
    private _streaming;
    private _passive;
    private _client;
    private _dashboard;
     ...
     */
    get parent(): JDNode;
    private handleRealTimeClockSync;
     ...
     * @internal
     */
    sendPacketAsync(packet: Packet): Promise<void>;
    /**
    ...
    get lastResetInTime(): number;
    private sendResetIn;
    sendStopStreaming(): Promise<void>;
    private sendPingLoggers;
    /**
