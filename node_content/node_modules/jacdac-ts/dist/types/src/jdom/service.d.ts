 ...
 * @category JDOM
 */
export declare class JDService extends JDNode {
    /**
     ...
     * @category Control
     */
    resolveInstanceName(): Promise<string>;
    /**
     ...
     * @category Packets
     */
    sendCmdPackedAsync<TValues extends PackedValues>(cmd: number, values?: TValues, ack?: boolean): Promise<void>;
    /**
    ...
    receiveWithInPipe<TValues extends PackedValues>(cmd: number, packFormat: string, timeout?: number): Promise<TValues[]>;
}
