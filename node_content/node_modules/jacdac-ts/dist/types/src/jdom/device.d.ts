...
import { ControlAnnounceFlags } from "./constants";
 ...
 * @category JDOM
 */
export declare class DeviceStatsMonitor extends JDEventSource {
 ...
 * @category JDOM
 */
export declare class JDDevice extends JDNode {
    /**
    ...
    private _shortId;
    private _anonymizedId;
    private _services;
    private _ports;
    private _ackAwaiting;
    private _flashing;
    private _identifying;
     ...
     */
    readonly stats: DeviceStatsMonitor;
    /**
     ...
     * @internal
     */
    sendCtrlCommand(cmd: number, payload?: Uint8Array): Promise<void>;
    /**
     * @internal
     */
    processAnnouncement(pkt: Packet): void;
     ...
     * @category Control
     */
    resolveProductIdentifier(retry?: number): Promise<number>;
    /**
     ...
     * @internal
     */
    floodPing(numPkts?: number, size?: number): Promise<void>;
}
