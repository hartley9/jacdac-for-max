 ...
 */
export declare class DeviceCatalog extends JDEventSource {
     ...
     */
    update(specifications: jdspec.DeviceSpec[]): void;
    /**
     ...
     * @returns
     */
    specificationFromProductIdentifier(productIdentifier: number): jdspec.DeviceSpec;
     ...
     * @returns
     */
    matchVendorId(type: string, id: number): boolean;
    /**
     * Generates a unique firmware identifier
     * @returns
     */
    uniqueFirmwareId(): string;
    /**
