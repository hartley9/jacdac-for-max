 ...
 * @category Trace
 */
export declare class TraceView extends JDClient {
    readonly bus: JDBus;
    private id;
    private _maxFilteredLength;
    private _paused;
    private _trace;
    private _filter;
    private _packetFilter;
    private _filteredPackets;
    silent: boolean;
    private notifyPacketsChanged;
    constructor(bus: JDBus, filter: string, throttleDelay?: number);
    /**
    ...
    get trace(): Trace;
    set trace(t: Trace);
    get filteredPackets(): TracePacketProps[];
    get filter(): string;
    set filter(f: string);
    get maxFilteredLength(): number;
