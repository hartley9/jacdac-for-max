...
import { PackedObject } from "./packobject";
/**
 * A Jacdac register client.
 * @category JDOM
 */
export declare class JDRegister extends JDServiceMemberNode {
    private _lastReportPkt;
    private _fields;
    private _lastSetTimestamp;
    private _lastGetTimestamp;
    private _lastGetAttempts;
     ...
     * @category Packets
     */
    sendSetPackedAsync(values: PackedValues, autoRefresh?: boolean): Promise<void>;
    /**
