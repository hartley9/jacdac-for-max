 ...
 * @category JDOM
 */
export declare function dependencyId(nodes: IEventSource | IEventSource[]): string | number;
/**
 * Base class for evented nodes in Jacdac
 * @category JDOM
 */
export declare class JDEventSource implements IEventSource {
    /**
     ...
     * @category JDOM
     */
    newListenerStats: Record<string, number>;
    /**
     * @internal
     */
    constructor();
