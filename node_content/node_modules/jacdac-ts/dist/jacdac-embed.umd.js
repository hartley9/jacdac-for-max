(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.jacdac = {}));
     ...
     * @internal
     */
    class IFrameTransport extends JDClient {
        constructor(origin) {
            super();
            this.origin = origin;
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    class ModelStore extends JDEventSource {
    }
    class HostedModelStore extends JDEventSource {
        constructor(transport) {
            super();
            this.transport = transport;
        ...
        models() {
            var _a, _b;
            return (_b = (_a = this._models) === null || _a === void 0 ? void 0 : _a.data.models) === null || _b === void 0 ? void 0 : _b.slice(0);
        }
        inputConfigurations() {
            var _a, _b;
            return (_b = (_a = this._models) === null || _a === void 0 ? void 0 : _a.data.inputConfigurations) === null || _b === void 0 ? void 0 : _b.slice(0);
        }
        async loadFile(model) {
            var _a;
            const { path } = model;
            ...
            const data = (_a = ack === null || ack === void 0 ? void 0 : ack.data) === null || _a === void 0 ? void 0 : _a.data;
            if (!data)
                return undefined;
    ...
    exports.BrowserFileStorage = BrowserFileStorage;
    exports.HostedFileStorage = HostedFileStorage;
    exports.HostedModelStore = HostedModelStore;
...
//# sourceMappingURL=jacdac-embed.umd.js.map
