...
(function (GamepadButtons) {
    GamepadButtons[GamepadButtons["Left"] = 1] = "Left";
    GamepadButtons[GamepadButtons["Up"] = 2] = "Up";
    GamepadButtons[GamepadButtons["Right"] = 4] = "Right";
    GamepadButtons[GamepadButtons["Down"] = 8] = "Down";
    GamepadButtons[GamepadButtons["A"] = 16] = "A";
    GamepadButtons[GamepadButtons["B"] = 32] = "B";
    GamepadButtons[GamepadButtons["Menu"] = 64] = "Menu";
    GamepadButtons[GamepadButtons["Select"] = 128] = "Select";
    GamepadButtons[GamepadButtons["Reset"] = 256] = "Reset";
    GamepadButtons[GamepadButtons["Exit"] = 512] = "Exit";
    GamepadButtons[GamepadButtons["X"] = 1024] = "X";
    GamepadButtons[GamepadButtons["Y"] = 2048] = "Y";
})(GamepadButtons || (GamepadButtons = {}));
var GamepadVariant;
(function (GamepadVariant) {
    GamepadVariant[GamepadVariant["Thumb"] = 1] = "Thumb";
    GamepadVariant[GamepadVariant["ArcadeBall"] = 2] = "ArcadeBall";
    GamepadVariant[GamepadVariant["ArcadeStick"] = 3] = "ArcadeStick";
    GamepadVariant[GamepadVariant["Gamepad"] = 4] = "Gamepad";
})(GamepadVariant || (GamepadVariant = {}));
var GamepadReg;
(function (GamepadReg) {
    /**
     ...
     * ```
     */
    GamepadReg[GamepadReg["Direction"] = 257] = "Direction";
    /**
     ...
     * ```
     */
    GamepadReg[GamepadReg["Variant"] = 263] = "Variant";
    /**
     ...
     * ```
     */
    GamepadReg[GamepadReg["ButtonsAvailable"] = 384] = "ButtonsAvailable";
})(GamepadReg || (GamepadReg = {}));
var GamepadEvent;
(function (GamepadEvent) {
     ...
     * ```
     */
    GamepadEvent[GamepadEvent["ButtonsChanged"] = 3] = "ButtonsChanged";
...
(function (LightLevelVariant) {
    ...
    LightLevelVariant[LightLevelVariant["ReverseBiasedLED"] = 2] = "ReverseBiasedLED";
...
(function (RotaryEncoderReg) {
     ...
     * ```
     */
    RotaryEncoderReg[RotaryEncoderReg["Clicker"] = 385] = "Clicker";
...
var TemperatureVariant;
(function (TemperatureVariant) {
    TemperatureVariant[TemperatureVariant["Outdoor"] = 1] = "Outdoor";
    TemperatureVariant[TemperatureVariant["Indoor"] = 2] = "Indoor";
    TemperatureVariant[TemperatureVariant["Body"] = 3] = "Body";
})(TemperatureVariant || (TemperatureVariant = {}));
var TemperatureReg;
(function (TemperatureReg) {
    /**
     ...
     * ```
     */
    TemperatureReg[TemperatureReg["Temperature"] = 257] = "Temperature";
    /**
     ...
     * ```
     */
    TemperatureReg[TemperatureReg["MinTemperature"] = 260] = "MinTemperature";
    /**
     ...
     * ```
     */
    TemperatureReg[TemperatureReg["MaxTemperature"] = 261] = "MaxTemperature";
    /**
     ...
     * ```
     */
    TemperatureReg[TemperatureReg["TemperatureError"] = 262] = "TemperatureError";
    /**
     ...
     * ```
     */
    TemperatureReg[TemperatureReg["Variant"] = 263] = "Variant";
