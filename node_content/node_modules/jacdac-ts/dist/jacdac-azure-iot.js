...
// Service: Dashboard
const SRV_DASHBOARD = 0x1be59107;
var DistanceVariant;
...
var serviceSpecificationData = [
	...
	},
	{
		...
		packets: [
			...
			},
			{
				...
				name: "hub_device_id",
				identifier: 385,
				description: "Device identifier in Azure Iot Hub if available.",
				fields: [
					{
						name: "_",
						type: "string",
	...
	},
	{
		...
		notes: {
			short: "Indicates that the device acts as a bridge to the Jacdac bus."
		},
		classIdentifier: 535147631,
		enums: {
		},
		constants: {
		},
		packets: [
			...
			},
			{
				...
				name: "enabled",
				identifier: 1,
				description: "Enables or disables the bridge.",
				fields: [
					{
						name: "_",
						type: "bool",
	...
	},
	{
		...
		notes: {
			short: "Device that interacts, configure or inspects with the services on the bus. While a dashboard is on the bus, heuristics like device reset should be disabled."
		},
		classIdentifier: 468029703,
		enums: {
		},
		constants: {
		},
	...
	},
	{
		...
		packets: [
			...
			},
			{
				...
				name: "bending",
				identifier: 257,
				description: "A measure of the bending.",
				fields: [
					{
						name: "_",
						unit: "/",
			...
			},
			{
				...
				name: "length",
				identifier: 384,
				description: "Length of the flex sensor",
				fields: [
					{
						name: "_",
						unit: "mm",
	...
	},
	{
		...
		packets: [
			...
			},
			{
				...
				name: "rotation_rates",
				identifier: 257,
				description: "Indicates the current rates acting on gyroscope.",
				fields: [
					{
						name: "x",
						unit: "°/s",
			...
			},
			{
				...
				name: "max_rate",
				identifier: 8,
				description: "Configures the range of rotation rates.\nThe value will be \"rounded up\" to one of `max_rates_supported`.",
				fields: [
					{
						name: "_",
						unit: "°/s",
			...
			{
				kind: "const",
				name: "max_rates_supported",
				identifier: 266,
				description: "Lists values supported for writing `max_rate`.",
				fields: [
					{
						name: "max_rate",
						unit: "°/s",
	...
	},
	{
		...
		notes: {
			short: "A light bulb controller."
		},
		classIdentifier: 480970060,
		enums: {
		},
		constants: {
		},
		packets: [
			...
			},
			{
				...
				name: "brightness",
				identifier: 1,
				description: "Indicates the brightness of the light bulb. Zero means completely off and 0xffff means completely on.\nFor non-dimmable lights, the value should be clamp to 0xffff for any non-zero value.",
				fields: [
					{
						name: "_",
						unit: "/",
			...
			},
			{
				...
				name: "dimmable",
				identifier: 384,
				description: "Indicates if the light supports dimming.",
				fields: [
					{
						name: "_",
						type: "bool",
	...
	},
	{
		...
		packets: [
			...
			{
				kind: "ro",
				name: "light_level_error",
				identifier: 262,
				description: "Absolute estimated error of the reading value",
				fields: [
					{
						name: "_",
						unit: "/",
	...
	},
	{
		...
		packets: [
			...
			},
			{
				...
				name: "forces_error",
				identifier: 262,
				description: "Absolute estimated error on the readings.",
				fields: [
					{
						name: "_",
						unit: "nT",
	...
	},
	{
		...
		packets: [
			...
			},
			{
				...
				name: "reversible",
				identifier: 386,
				description: "Indicates if the motor can run backwards.",
				fields: [
					{
						name: "_",
						type: "bool",
	...
	},
	{
		...
		packets: [
			...
			},
			{
				...
				name: "clicker",
				identifier: 385,
				description: "The encoder is combined with a clicker. If this is the case, the clicker button service\nshould follow this service in the service list of the device.",
				fields: [
					{
						name: "_",
						type: "bool",
	...
	},
	{
		...
		packets: [
			...
			},
			{
				...
				name: "moisture_error",
				identifier: 262,
				description: "The error on the moisture reading.",
				fields: [
					{
						name: "_",
						unit: "/",
	...
	},
	{
		...
		status: "stable",
		shortId: "uniquebrain",
		camelName: "uniqueBrain",
		shortName: "uniqueBrain",
		"extends": [
			"_base"
		],
		notes: {
			short: "The presence of this service indicates that this device is a client that controls sensors and actuators.\nIf a unique brain detects another younger unique brain (determined by reset counter in announce packets),\nthen the older brain should switch into proxy mode."
		},
		classIdentifier: 272387813,
		enums: {
		},
		constants: {
		},
	...
	},
	{
		...
		packets: [
			...
			},
			{
				...
				name: "level_error",
				identifier: 262,
				description: "The error rage on the current reading",
				fields: [
					{
						name: "_",
						unit: "/",
...
function serviceSpecificationToServiceTwinSpecification(specification) {
    ...
    const registers = packets
        ...
        let flags = 0;
        if (reg.kind == "const")
            flags |= ServiceTwinRegisterFlag.Const;
        if (reg.volatile)
...
export { ServiceTwinRegisterFlag, serviceSpecificationToServiceTwinSpecification, serviceSpecificationsWithServiceTwinSpecification };
//# sourceMappingURL=jacdac-azure-iot.js.map
