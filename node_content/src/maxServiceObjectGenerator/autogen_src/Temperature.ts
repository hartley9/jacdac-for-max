...
const [minTemperature] : [number] = minTemperatureReg.unpackedValue

// get (register to REPORT_UPDATE event to enable background refresh)
const maxTemperatureReg = service.register(TemperatureReg.MaxTemperature)
const [maxTemperature] : [number] = maxTemperatureReg.unpackedValue
...
const [variant] : [jacdac.TemperatureVariant] = variantReg.unpackedValue
