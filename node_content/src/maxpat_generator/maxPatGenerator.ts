...
interface Outlet extends Box {
	maxclass: "outlet"
	index: number; 
	numinlets: 1, 
	numoutlets: 0
	patching_rect: [number, number, 30, 30]
	comment?: string 
}
...
function serviceToMaxObjects(service): MaxPatch | null{
...
function generateFormattingObjects(register, outputFormat: string, registerNum: number, registerLength: number): MaxPatch{
...
function generateOutlets(service: JDService, registers: any[], routeObject: Box, registersEvent: any[], routeEventObject: Box,): MaxPatch {
	...
	let allFormattingObjects: MaxPatch = {lines: [], boxes: []};
...
function addMaxObjectObject(name: string, params: {}){
